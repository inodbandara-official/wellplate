...
def get_recommendations():
    blood_sugar_level = request.form.get('blood-sugar-level')
    allergies = request.form.get('allergies')
    is_vegetarian = request.form.get('is-vegetarian') == 'on'
    cheat_day = request.form.get('cheat-day') == 'on'

    recommendations = main.get_recommendations(
        allergies=allergies,
    ...
    html_response = f"""
            ...
            <body>
                <div class="container">
                    <h1>Your Meal Recommendations</h1>
